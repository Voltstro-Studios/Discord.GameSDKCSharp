...
namespace Discord.GameSDK
{
	...
	public sealed class Discord : IDisposable
    {
        ...
        /// 
        /// <para>This function also serves as a way to know that the local Discord client is still connected.
        /// If the user closes Discord while playing your game, <see cref="RunCallbacks"/> will throw <see cref="Result.NotRunning"/>.</para>
        /// </summary>
        /// <exception cref="ResultException"></exception>
