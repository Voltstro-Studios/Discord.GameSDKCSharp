...
{
    /// <summary>
    /// Looking to integrate Rich Presence into your game? No need to manage multiple SDKs—this one does all that awesome stuff, too!.
    /// Delight your players with the ability to post game invites in chat and party up directly from Discord.
    /// Surface interesting live game data in their profile and on the Games Tab for their friends, encouraging them to group up and play together.
    /// <para>For more detailed information and documentation around the Rich Presence feature set and integration tips, check out our <a href="https://discord.com/developers/docs/rich-presence/how-to">Rich Presence Documentation</a>.</para>
    /// </summary>
	public sealed class ActivityManager
    {
        ...
        /// <para>On macOS, due to the way Discord registers executables, your game needs to be bundled for this command to work. That means it should be a <c>.app</c>.</para>
        /// </summary>
        ...
        /// <summary>
        /// Used if you are distributing this SDK on Steam. Registers your game's Steam app id for the protocol <c>steam://run-game-id/id</c>.
        /// </summary>
        ...
        /// <para>It is possible for users to hide their presence on Discord (User Settings -> Game Activity). Presence set through this SDK may not be visible when this setting is toggled off.</para>
        /// </summary>
        ...
        /// See <a href="https://discord.com/developers/docs/game-sdk/activities#activity-action-field-requirements">Activity Action Field Requirement</a> for the fields required to have join and spectate invites function properly.
        /// </summary>
        /// <param name="userId"></param>
